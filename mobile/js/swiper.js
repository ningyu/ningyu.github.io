...
$(function()
{
    ...
    function page1(slide)
    {
        ...
        var timeid = window.setInterval(function()
        {
            ...
            var n = parseInt($(".icons_mm span").eq(i).html());
            $(".icons_mm span").eq(i).html(n + 1);
            $(".icons_mm span").eq(i).animate({
                zoom: '1.1'
            }, 50);
            $(".icons_mm span").eq(i).animate({
                zoom: '1'
        ...
        // “你收到一到微信消息”提示框，点击“关闭”按钮，隐藏微信对话，500毫秒后再次弹出微信对话框   点击“打开”按钮，显示微信对话
        ...
        $(document).on("tap", ".rightbtn", function(event)
        {
            ...
            window.setTimeout(function()
            {
                ...
                $(".xx2").fadeIn(10).delay(2000).fadeOut(10, function()
                {
                    ...
                    $(".wx5 span").fadeOut(10);
                    $(".xx4").fadeIn(10).delay(3000).animate({
                        opacity: 1
                    }, 10, function()
                    {
                        $(".tishi2").fadeIn(10);
        ...
        /*
         * $(document).on("tap",".wx1",function(event){ $(".wx_title
         * p").html('内内内内部工作群'); $(".wx_title
         * img").attr('src',"images/wx_title21.png"); $(".zhuxx").fadeOut(10);
         * $(".xinxi").fadeIn(10); $(".xx5").fadeIn(10); $(".wx1
         * span").fadeOut(10);
         * 
         * var timeid2 = window.setInterval(function(){ var bu =
         * parseInt($(".xx5").css('background-position-y')); bu = bu - 160;
         * $(".xx5").animate({'background-position-y':bu + 'px'}); },500);
         * 
         * window.setTimeout(function(){ window.clearInterval(timeid2);
         * $(".tishi2").fadeIn(10); $(".zhezhao").fadeIn(10); },10000); });
         * 
         * $(document).on("tap",".wx2",function(event){ $(".wx_title
         * img").attr('src',"images/wx_title.png"); $(".zhuxx").fadeOut(10);
         * $(".xinxi").fadeIn(10); $(".xx1").fadeIn(10); $(".wx2
         * span").fadeOut(10); }); $(document).on("tap",".wx3",function(event){
         * $(".wx_title p").html('老同学群'); $(".wx_title
         * img").attr('src',"images/wx_title.png"); $(".zhuxx").fadeOut(10);
         * $(".xinxi").fadeIn(10); $(".xx3").fadeIn(10); $(".wx3
         * span").fadeOut(10); }); $(document).on("tap",".wx4",function(event){
         * $(".wx_title p").html('郭姐'); $(".wx_title
         * img").attr('src',"images/wx_title.png"); $(".zhuxx").fadeOut(10);
         * $(".xinxi").fadeIn(10); $(".xx2").fadeIn(10); $(".wx4
         * span").fadeOut(10); }); $(document).on("tap",".wx5",function(event){
         * $(".wx_title p").html('tommy仔'); $(".wx_title
         * img").attr('src',"images/wx_title.png"); $(".zhuxx").fadeOut(10);
         * $(".xinxi").fadeIn(10); $(".xx4").fadeIn(10); $(".wx5
         * span").fadeOut(10); });
         */
        
        // “你将退出微信”提示框，点击“确认”按钮，关闭微信对话
        ...
        // 收到短信息提示框/退出微信提示框，点击“关闭”按钮，关闭短信框或显示微信提示
        ...
        // 点击“你有一笔代付申请需要付款”的“打开”按钮，打开“账单详情”页
        ...
        /*
         * $(document).on("tap",".qf3",function(event){ $(".zhifu").fadeIn(10);
         * $(".querenzhifu").fadeOut(10); $(".zhifubaotuichu").fadeIn(10);
         * 
         * window.setTimeout(function(){ $(".temp1").fadeOut(10);
         * $(".temp4").fadeOut(10); $(".temp1 .icons_zfb span").fadeOut(100);
         * $(".temp6").delay(1000).fadeIn(100);
         * document.getElementById("ldmusic").play(); },2000); });
         */

        // 点击“选择其他付款方式”按钮，显示电话呼入界面，播放来电声音
         ...
         * $(".momo_tishi").fadeOut(10); $(".fuceng2").fadeOut(10);
         ...
         * $(".momo_mes").fadeOut(10); $(".mx2 span").fadeOut(10);
         * window.setTimeout(function(){ $(".momo_tuichu").fadeIn(10);
         * $(".fuceng2").fadeIn(10); },1000); });
         * $(document).on("tap",".mc3",function(event){ $(".temp5").fadeOut(10);
         * $(".temp1").fadeOut(10); $(".temp1 .icons_mm span").fadeOut(100);
         * $(".temp6").delay(1000).fadeIn(100);
         * document.getElementById("ldmusic").play(); });
         */
        
        // 点击“陌陌”APP 
        $(document).on("tap", ".icons_mm", function(event)
        {
            alert("……想不到你是这种人……");
        });
        ...
        // 点击“你想静静吗？其实生活还有另外一种可能”弹出界面的“查看”按钮，显示渐显的8条文字：“我们为什么而活，我们的价值在哪，有没有一次机会……”
        ...
        // 点击嗷大喵“来打我呀”
        $(document).on("tap", ".jump", function(event)
        {
            window.location.href = "http://www.clingtony.com";
        });
    }
    ...
    var imgList = [ 'http://p1.bpimg.com/567571/b61afab2ef3c870a.jpg' ];
    var audioList = [ 'js/duanxin2.mp3', 'js/laidian.mp3', 'js/dianhua.mp3', 'js/begin.mp3', 'js/luanting5.mp3', 'js/ab.mp3' ];
    ...
    function loadAudio()
    {
        var audioSize = audioList.length;
        var loadnum = 0;
        var audio = [];
        ...
        {
            loadnum++;
            var shu = parseInt(loadnum / audioSize * 100);
            $(".progress").html(shu + "%");
            
            // return false;
            if (loadnum == audio.length)
            {
